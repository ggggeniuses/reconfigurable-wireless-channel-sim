function [xi_T_n_t, xi_R_n_t, nu_t, theta_ver_T_n_t, theta_azi_T_n_t, theta_ver_R_n_t, theta_azi_R_n_t] = rho_FCF_cluster_time_BDCM(v_T, v_R,...
...
theta_azi_T_n_t = delta_T/lambda_fc * cos(beta_T_n_t)*cos(psi_ver_T)*cos(alpha_T_n_t - psi_azi_T);
theta_ver_T_n_t = delta_T/lambda_fc * sin(beta_T_n_t)*sin(psi_ver_T);
theta_azi_R_n_t = delta_R/lambda_fc * cos(beta_R_n_t)*cos(psi_ver_R)*cos(alpha_R_n_t - psi_azi_R);
theta_ver_R_n_t = delta_R/lambda_fc * sin(beta_R_n_t)*sin(psi_ver_R);
