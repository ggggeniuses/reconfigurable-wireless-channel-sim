function [xi_T_m_sub_t, xi_R_m_sub_t, nu_t, theta_T_ver_mxmz_t, theta_T_azi_mxmz_t, theta_R_ver_mxmz_t, theta_R_azi_mxmz_t] = rho_FCF_RIS_time_BDCM(v_T, v_R, eta_ver_T, eta_azi_T, ...
...
theta_T_ver_mxmz_t = delta_T/lambda_fc * cos(beta_T_m_sub_t)*cos(psi_ver_T)*cos(alpha_T_m_sub_t - psi_azi_T);
theta_T_azi_mxmz_t = delta_T/lambda_fc * sin(beta_T_m_sub_t)*sin(psi_ver_T);
theta_R_ver_mxmz_t = delta_R/lambda_fc * cos(beta_R_m_sub_t)*cos(psi_ver_R)*cos(alpha_R_m_sub_t - psi_azi_R);
theta_R_azi_mxmz_t = delta_R/lambda_fc * sin(beta_R_m_sub_t)*sin(psi_ver_R);
end
