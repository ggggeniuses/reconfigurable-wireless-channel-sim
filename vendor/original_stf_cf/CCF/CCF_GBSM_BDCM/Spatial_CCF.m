...
y_m_sub = 30;                                     
z_m_sub = 20;                                   
M_x = 30;                                    % number of columns, M_x
M_z = 30;                                    % number of rows, M_z
...
plot(delta_q, abs(rho_CCF_NLoS_cluster_GBSM), 'k-+', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'k', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
plot(delta_q, abs(rho_CCF_NLoS_cluster_BDCM), 'k-d', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'k', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
plot(delta_q, abs(rho_CCF_VLoS_RIS_GBSM), 'b-', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'b', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
plot(delta_q, abs(rho_CCF_VLoS_RIS_BDCM), 'b-*', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'b', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
plot(delta_q, abs(rho_CCF_cluster_RIS_GBSM), 'm--', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'r', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
plot(delta_q, abs(rho_CCF_cluster_RIS_BDCM), 'm--o', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'm', 'MarkerIndices', [1:1:floor(0.5*length(delta_q)),  floor(0.5*length(delta_q))+1 : 4 : length(delta_q) ]);
hold on
...
axis([0 30 0 1])
xlab = xlabel('');
set(xlab, 'Interpreter', 'latex', 'string',{'Antenna indenx or beam index'}, 'Fontsize', 12);
ylab = ylabel('');
set(ylab, 'Interpreter', 'latex', 'string',{'Spatial CCFs'}, 'Fontsize', 12);
grid on
