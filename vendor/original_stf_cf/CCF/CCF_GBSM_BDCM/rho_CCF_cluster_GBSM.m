function rho_CCF_NLoS_cluster_rng_nor = rho_CCF_cluster_GBSM(j, lambda, v_T, v_R, eta_ver_T, eta_azi_T, ...
...
for id_1 = 1 : length(delta_q)   
    ...
    for alpha_R_n = AAoA_low : AAoA_step : AAoA_up             % sum with AAoA
        for beta_R_n = EAoA_low : EAoA_step : EAoA_up          % sum with EAoA
            ...
            [xi_T_n_t, xi_R_n_t, nu_t, p_q_term_t] = rho_CCF_cluster_time_GBSM(v_T, v_R, eta_ver_T, eta_azi_T, ...
                                                    eta_azi_R, t, d_n, D_0, H_0, P, Q, p, q, delta_T, delta_R, ...
                                                    psi_ver_T, psi_azi_T, psi_ver_R, psi_azi_R);
            
            [xi_T_n_tt, xi_R_n_tt, nu_tt, p_q_term_tt] = rho_CCF_cluster_time_GBSM(v_T, v_R, eta_ver_T, eta_azi_T, ...
