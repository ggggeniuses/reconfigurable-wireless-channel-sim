function rho_CCF_RIS_on_UAV_optimal_rng_nor = rho_CCF_RIS_GBSM(j, lambda, v_T, v_R, eta_ver_T, eta_azi_T, eta_azi_R, delta_T,...
...
%             z_mxmz = Z_RIS - (M_z/2 - mz + 0.5)*d_mz;
            ...
            [xi_T_m_sub_t, xi_R_m_sub_t, nu_t, p_q_term_t] = rho_CCF_RIS_time_GBSM(v_T, v_R, eta_ver_T, eta_azi_T, ...
                                                eta_azi_R, t, d_m_sub, D_0, H_0, P, Q, p, q, delta_T, delta_R, ...
                                                psi_ver_T, psi_azi_T, psi_ver_R, psi_azi_R);
            
            [xi_T_m_sub_tt, xi_R_m_sub_tt, nu_tt, p_q_term_tt] = rho_CCF_RIS_time_GBSM(v_T, v_R, eta_ver_T, eta_azi_T, ...
