function rho_ACF_RIS_on_UAV_optimal_rng_nor = rho_ACF_RIS_BDCM(j, lambda, v_T, v_R, eta_ver_T, eta_azi_T, eta_azi_R, delta_T,...
...
%             z_mxmz = Z_RIS - (M_z/2 - mz + 0.5)*d_mz;
            ...
            [xi_T_m_sub_t, xi_R_m_sub_t, nu_t, theta_T_ver_mxmz_t, theta_T_azi_mxmz_t, theta_R_ver_mxmz_t, theta_R_azi_mxmz_t] = rho_ACF_RIS_time_BDCM(v_T, v_R, eta_ver_T, eta_azi_T, ...
                                                eta_azi_R, t, d_m_sub, D_0, H_0, P, Q, p, q, delta_T, delta_R, ...
                                                psi_ver_T, psi_azi_T, psi_ver_R, psi_azi_R, lambda);
            
            [xi_T_m_sub_tt, xi_R_m_sub_tt, nu_tt, theta_T_ver_mxmz_tt, theta_T_azi_mxmz_tt, theta_R_ver_mxmz_tt, theta_R_azi_mxmz_tt] = rho_ACF_RIS_time_BDCM(v_T, v_R, eta_ver_T, eta_azi_T, ...
