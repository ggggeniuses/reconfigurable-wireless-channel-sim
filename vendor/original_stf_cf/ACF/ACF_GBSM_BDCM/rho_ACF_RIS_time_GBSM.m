function [xi_T_m_sub_t, xi_R_m_sub_t, nu_t, p_q_term_t] = rho_ACF_RIS_time_GBSM(v_T, v_R, eta_ver_T, eta_azi_T, ...
...
p_q_term_t = dot(e_T_m_sub_t, d_T_p) + dot(e_T_m_sub_t, d_R_q);
end
