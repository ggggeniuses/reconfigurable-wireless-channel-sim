...
plot(delta_t, abs(rho_ACF_NLoS_cluster_GBSM), 'k-+', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'k', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
plot(delta_t, abs(rho_ACF_NLoS_cluster_BDCM), 'k-d', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'k', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
plot(delta_t, abs(rho_ACF_VLoS_RIS_GBSM), 'b-', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'b', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
plot(delta_t, abs(rho_ACF_VLoS_RIS_BDCM), 'b-*', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'b', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
plot(delta_t, abs(rho_ACF_cluster_RIS_GBSM), 'm--', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'r', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
plot(delta_t, abs(rho_ACF_cluster_RIS_BDCM), 'm--o', 'LineWidth', 1.25, 'MarkerSize', 6, 'MarkerEdgeColor', 'm', 'MarkerIndices', [1:1:floor(0.5*length(delta_t)),  floor(0.5*length(delta_t))+1 : 4 : length(delta_t) ]);
hold on
...
axis([0 0.02 0 1])
xlab = xlabel('');
set(xlab, 'Interpreter', 'latex', 'string',{'Time difference, $\Delta t$, [s]'}, 'Fontsize', 12);
ylab = ylabel('');
set(ylab, 'Interpreter', 'latex', 'string',{'Temporal ACFs'}, 'Fontsize', 12);
grid on
