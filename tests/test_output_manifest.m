...
fasShipRoot = fullfile(risRoot, 'fas_ship');
...
required = { ...
    ...
    fullfile(fasShipRoot, 'acf_vs_distance.mat'), ...
    fullfile(fasShipRoot, 'acf_vs_rician_factor.mat'), ...
    fullfile(fasShipRoot, 'fas_selection_gain.mat'), ...
    fullfile(fasShipRoot, 'acf_vs_ris_location.mat')};
...
requiredFigures = { ...
    ...
    fullfile(cfg.output.figureDir, 'fas_ship', 'acf_vs_distance.png'), ...
    fullfile(cfg.output.figureDir, 'fas_ship', 'acf_vs_rician_factor.png'), ...
    fullfile(cfg.output.figureDir, 'fas_ship', 'fas_selection_gain.png'), ...
    fullfile(cfg.output.figureDir, 'fas_ship', 'acf_vs_ris_location.png')};
...
maritime = load(fullfile(fasShipRoot, 'acf_vs_distance.mat'));
assert(isfield(maritime, 'acf') && all(isfinite(maritime.acf(:))), ...
    'Maritime ACF output must include finite curve data.');
